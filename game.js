...
document.querySelector(".game-settings").onclick = function() {
    ...
    document.body.innerHTML += `<div class="settings-container">
        ...
        <div class="settings-content">
            <div class="settings-item">
               <svg height="30px" width="30px" fill="#000000" viewBox="0 0 24 24" id="sound-min" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" class="icon flat-color"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="secondary" d="M17.54,16.54a1,1,0,0,1-.71-.3,1,1,0,0,1,0-1.41,4,4,0,0,0,0-5.66,1,1,0,1,1,1.41-1.41,6,6,0,0,1,0,8.48A1,1,0,0,1,17.54,16.54Z" style="fill: #ffffff;"></path><path id="primary" d="M13.38,4.08a1,1,0,0,0-1.09.21L8.59,8H6a2,2,0,0,0-2,2v4a2,2,0,0,0,2,2H8.59l3.7,3.71A1,1,0,0,0,13,20a.84.84,0,0,0,.38-.08A1,1,0,0,0,14,19V5A1,1,0,0,0,13.38,4.08Z" style="fill: #ffffff;"></path></g></svg>
            ...
            <div class="settings-item">
               <svg height="30px" width="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M2 6L3.06051 7.11942C3.58133 7.66918 3.56352 8.53546 3.02055 9.06335L3 9.08333C2.45233 9.61579 2.45233 10.4953 3 11.0278V11.0278C3.54767 11.5602 3.54767 12.4398 3 12.9722V12.9722C2.45233 13.5047 2.45233 14.3842 3 14.9167L3.02055 14.9366C3.56351 15.4645 3.58132 16.3308 3.0605 16.8806L2 18M22 6L20.9395 7.11942C20.4187 7.66918 20.4365 8.53546 20.9794 9.06335L21 9.08333C21.5477 9.61579 21.5477 10.4953 21 11.0278V11.0278C20.4523 11.5602 20.4523 12.4398 21 12.9722V12.9722C21.5477 13.5047 21.5477 14.3842 21 14.9167L20.9795 14.9366C20.4365 15.4645 20.4187 16.3308 20.9395 16.8806L22 18M7 5L7 19C7 20.1046 7.89543 21 9 21H15C16.1046 21 17 20.1046 17 19V5C17 3.89543 16.1046 3 15 3L9 3C7.89543 3 7 3.89543 7 5Z" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
